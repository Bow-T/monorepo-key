// widget_test.dart
// ----------------
// Smoke test: app cài đặt dựng được và hiển thị tiêu đề "BOW KEY".
...
void main() {
  testWidgets('Màn hình cài đặt hiển thị tiêu đề Bow Key', (tester) async {
    ...
    expect(find.text('BOW KEY'), findsOneWidget);
